...
final class StoreUsersRequest extends ApiFormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        */
        ...
        return [
            ...
            'tipo' => ['exists:uneg.tipos_trabajadores,id', 'required'],
            'relacion_laboral' => ['exists:uneg.relaciones_laborales,id', 'required'],
            'sueldo' => ['decimal:0,2', 'required', 'min:0'],
            'zona' => ['exists:uneg.zonas,uuid', 'nullable'],
            'sede' => ['exists:uneg.sedes,uuid', 'nullable'],
            'retiro_uneg' => ['date', 'gt:ingreso_uneg', 'nullable', 'before:tomorrow'],
    ...
    public function messages(): array
    {
        return [
            ...
            'beneficiario.*.nombre.required' => 'El nombre del beneficiario #:position es obligatorio',
            'beneficiario.*.nombre.min' => 'El nombre del beneficiario #:position debe tener como mínimo 3 caracteres',
            'beneficiario.*.fecha_nacimiento.required' => 'La fecha de nacimiento del beneficiario #:position es obligatorio',
            'beneficiario.*.fecha_nacimiento.date' => 'La fecha de nacimiento del beneficiario #:position tiene un formato invalido',
            'beneficiario.*.fecha_nacimiento.before' => 'El beneficiario #:position debe tener una fecha de nacimiento anterior a hoy',
            'beneficiario.*.nacionalidad.required' => 'La nacionalidad del beneficiario #:position es obligatoria',
            'beneficiario.*.nacionalidad.alpha' => 'Formato de cédula del beneficiario #:position debe tener solo una letra',
            'beneficiario.*.nacionalidad.in' => 'La nacionalidad del beneficiario #:position no es válida',
            'beneficiario.*.cedula.required' => 'El número de cédula del beneficiario #:position es obligatorio',
            'beneficiario.*.cedula.numeric' => 'El número de cédula del beneficiario #:position debe ser solo números',
            'beneficiario.*.cedula.max' => 'El número de cédula del beneficiario #:position especificado no es válido',
            'beneficiario.*.email.required' => 'El correo electronico del beneficiario #:position es obligatorio',
            'beneficiario.*.email.email' => 'El correo electronico del beneficiario #:position tiene un formato invalido',
            'beneficiario.*.telefono.regex' => 'El teléfono del beneficiario #:position no tiene un formato válido',
            'beneficiario.*.telefono.required' => 'El teléfono del beneficiario #:position es obligatorio',
            'beneficiario.*.telefono_secundario.regex:/\d{11}/' => 'El teléfono secundario del beneficiario #:position no tiene un formato válido',
