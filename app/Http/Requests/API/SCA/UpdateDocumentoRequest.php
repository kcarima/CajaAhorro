...
final class UpdateDocumentoRequest extends ApiFormRequest
{
    /**
    ...
    {
        $documento = Documento::where('uuid', $this->uuid)->firstOrFail();

        return [
            'nombre' => ['required', Rule::unique('uneg.sedes')->ignore($documento)],
            'carpeta' => ['required'],
        ];
    }
