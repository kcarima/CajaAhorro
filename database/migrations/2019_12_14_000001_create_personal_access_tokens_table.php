...
return new class extends Migration
{
    ...
    {
        Schema::connection(name: 'seguridad')->create(table: 'personal_access_tokens', callback: function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection(name: 'seguridad')->dropIfExists(table: 'personal_access_tokens');
    }
};
