                            ...
                            <div class="text-lg w-full text-black border-2 border-solid border-gray-300">
                                ...
                                <div class="grid 2xl:grid-cols-5 md:grid-cols-2 sm:grid-cols-2 grid-cols-2 items-center gap-2 mx-2 mt-2" >
                                    <div>
                                        ...
                                        <x-input type="number" wire:model="monto_solicitud"  class="w-full text-end" required id="monto_solicitud" name="monto_solicitud" />
                                        @error('monto_solicitud')
                                            <span class="text-red-500">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                @if (session('monto_solicitud'))
                                    <p class="text-danger">{{session('monto_solicitud')}}</p>
                                @endif
                                <br>
