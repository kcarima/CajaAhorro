<div>
    ...
    <x-tabla titulo="Registro de Zonas">
            ...
            @forelse ($zonas as $zona)
                <tr>
                    <td class="text-center">
                        ...
                        <x-input type="text" name="nombre" class="hidden" value="{{ $zona->nombre }}" />
                    </td>
                    <td class="text-center">
                        <input type="hidden" name="uuid" value="{{ $zona->uuid }}">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                @if ($zona->deleted_at == '')
                                    <button class="dropdown-item edit-btn"><i class="bx bx-edit-alt me-1"></i>
                                        Editar</button>
                                    <button class="dropdown-item del-btn" data-module="zonas"
                                        data-id="{{ $zona->uuid }}"><i class="bx bx-trash me-1"></i>
                                        Eliminar</button>
                                    @if (auth()->user()->is_root())
                                        <button class="dropdown-item del-def-btn" wire:key="1_{{ $zona->uuid }}"
                                            data-id={{ $zona->uuid }} data-module="zonas">
                                            <i class='bx bx-message-alt-x'></i>
                                            Eliminar definitivo</button>
                                    @endif
                                    <button class="dropdown-item hidden save-btn"
                                        data-url={{ route('zona.update', $zona->uuid) }}>
                                ...
                                @else
                                    @if (auth()->user()->is_root())
                                        <button class="dropdown-item" wire:key="2_{{ $zona->uuid }}"
                                            wire:click="restaurar('{{ $zona->uuid }}')"><i
            ...
            <td class="text-center">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <button class="dropdown-item edit-btn"><i class="bx bx-edit-alt me-1"></i>
                            Editar</button>
                        <button class="dropdown-item del-btn" data-module="zonas" data-id=""><i
        ...
        <tr>
            ...
            <td class="text-center">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <button data-url="{{ route('zona.store') }}" class="dropdown-item">
