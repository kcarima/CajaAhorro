<div>
    ...
    <x-tabla titulo="Registro de Sedes">
            ...
            @forelse ($sedes as $sede)
                <tr>
                    <td class="text-center">
                        ...
                        <x-input type="text" name="nombre" class="hidden" value="{{ $sede->nombre }}" />
                    </td>
                    <td class="text-center">
                        <input type="hidden" name="uuid" value="{{ $sede->uuid }}">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                @if ($sede->deleted_at == '')
                                    <button class="dropdown-item edit-btn"><i class="bx bx-edit-alt me-1"></i>
                                        Editar</button>
                                    <button class="dropdown-item del-btn" data-module="sedes"
                                        data-id="{{ $sede->uuid }}"><i class="bx bx-trash me-1"></i>
                                        Eliminar</button>
                                    @if (auth()->user()->is_root())
                                        <button class="dropdown-item del-def-btn" wire:key="1_{{ $sede->uuid }}"
                                            data-id={{ $sede->uuid }} data-module="sedes">
                                            <i class='bx bx-message-alt-x'></i>
                                            Eliminar definitivo</button>
                                    @endif
                                    <button class="dropdown-item hidden save-btn"
                                        data-url={{ route('sede.update', $sede->uuid) }}>
                                ...
                                @else
                                    @if (auth()->user()->is_root())
                                        <button class="dropdown-item" wire:key="2_{{ $sede->uuid }}"
                                            wire:click="restaurar('{{ $sede->uuid }}')"><i
            ...
            <td class="text-center">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <button class="dropdown-item edit-btn"><i class="bx bx-edit-alt me-1"></i>
                            Editar</button>
                        <button class="dropdown-item del-btn" data-module="sedes" data-id=""><i
        ...
        <tr>
            ...
            <td class="text-center">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <button data-url="{{ route('sede.store') }}" class="dropdown-item">
