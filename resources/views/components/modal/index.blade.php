...
<div x-data="{ open: false }" {{ $attributes->merge(['class' => 'rounded-md']) }} {{ $attributes }} >

    <!-- Botón para abrir el modal-->
    <button type="button" @click="open = true" {{ $button->attributes->merge(['class' => 'text-lg w-full h-full']) }}>
        {{ $button }}
    </button>

    <div x-show="open" x-cloak class="fixed z-[1000] lg:-inset-20 inset-0">
        ...
        <div class="modal-flex-container flex items-end justify-center pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="modal-space-container sm:inline-block sm:align-middle lg:h-screen"></div>
            ...
            <div id="modal-container"
                ...
                <div
                    class="modal-actions bg-gray-200 px-4 py-3 flex justify-evenly lg:flex-row sm:flex-col-reverse flex-col-reverse lg:gap-2 sm:gap-4 gap-4">
                    {{ $footer ?? '' }}
                </div>
