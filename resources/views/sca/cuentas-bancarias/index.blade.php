<x-app-layout>
    ...
    @push('search')
        <x-utils.buscador modulo="cuenta-bancaria" />
    @endpush

    <div class="w-full flex justify-end">
        <a href="{{ route('cuenta-bancaria.create') }}" class="flex gap-2 rounded-md bg-white shadow-md p-2 items-center mb-4 hover:shadow-lg hover:cursor-pointer">
    ...
    @livewire('sca.cuentas-bancarias.cuentas-bancarias-component')
