<x-app-layout>
    ...
    @push('search')
        <x-utils.buscador modulo="parentesco" />
    @endpush

    <div class="w-full flex justify-end">

        <button id="btn-agregar" class="flex gap-2 rounded-md bg-white shadow-md p-2 items-center mb-4 hover:shadow-lg">
    ...
    @livewire('sca.parentesco.parentesco-component')
